...
The composition is an adapter, not a rivalry: a ROS 2 bridge would run as a ROS node, translating topics/tf/actions into AWP channels/frames/actions and enforcing the safety policy at the boundary. [Wrap a robot](/guides/wrap-a-robot) describes building one.
