...
Layer 3 fixes the shared conventions:
...
- **Scene graphs** — an optional semantic channel exposing entities, affordances, and relations as structured JSON. Useful for agents that reason in symbols rather than pixels. See [scene graphs](/spec/semantics/scene-graphs).
