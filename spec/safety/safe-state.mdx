...
A responsive connection does not prove that the agent is still driving; a live agent process does not prove that its policy is still deciding; a retained session token does not mean stale motion may continue; a fresh intent may rest on an old observation.
