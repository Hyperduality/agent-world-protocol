...
Each action type declares its preemption policy in the manifest; the submitter selects one of the declared options per submission, and a submission that selects none gets the first the type declares. `[AWP-PRE-001]`
