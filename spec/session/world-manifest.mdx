...
description: "The self-description a world returns from initialize."
---

Returned by `initialize`. A complete manifest ([`examples/v0.1/world-manifest.json`](https://github.com/Hyperduality/agent-world-protocol/blob/main/examples/v0.1/world-manifest.json)), valid against [`world-manifest.schema.json`](/api-reference/schemas/world-manifest):
