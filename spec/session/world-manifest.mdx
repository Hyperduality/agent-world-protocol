...
```json awp:world-manifest
{
  ...
  "observation_channels": [
    ...
    { "id": "events", "modality": "text/event+json", "rate_hz": null, "loss_class": "reliable",
      "schema": { "$ref": "https://agentworldprotocol.com/schemas/v0.1/world-event.schema.json" } }
  ],
  "action_schemas": [
...
- Worlds offering `lockstep` MUST declare `tick_policy` (`on_tick`) and `tick_authority` (`any_session` | `barrier`); worlds offering `streaming` MUST declare `safety_policy.safe_state` ([time models](/spec/loop/time-models), [safe state](/spec/safety/safe-state)). `[AWP-MAN-006]`
