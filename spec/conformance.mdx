...
- **Profile conformance** — a Core-conformant implementation additionally satisfying all MUSTs of a named [profile](/spec/profiles/core). Claims are per-profile and name the draft revision (e.g. "Core World + sim + robotics (experimental; no force monitoring), self-assessed against 0.1-draft.5"). `[AWP-CNF-003]`
