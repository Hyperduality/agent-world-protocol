...
Intended for: RL/eval harnesses, game-logic testbeds, digital twins in analysis mode. A Gymnasium bridge can claim it only for environments that support snapshot/restore (picklable state); others can claim Core only.
