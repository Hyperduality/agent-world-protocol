...
All vectors, including the malformed ones a decoder must reject, are in [`schemas/test-vectors/frames.json`](https://github.com/Hyperduality/agent-world-protocol/blob/main/schemas/test-vectors/frames.json) (AWP-DAT-008).
