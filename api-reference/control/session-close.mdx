...
<ParamField body="reason" type="string">`opened`, `first_activity`, `connection_lost`, `resumed`, `session_closed`, `window_expired`, `world_shutdown`, `transferred`, or `connection_replaced` (AWP-SES-010).</ParamField>
