...
The reference world, [awp-sim](/adapters/awp-sim), implements the lockstep steps above over a simulated arm; its engine cites each requirement where it applies. For Gymnasium environments, a [bridge](/adapters/gymnasium-bridge) that does this mapping generically is planned and not published yet.
